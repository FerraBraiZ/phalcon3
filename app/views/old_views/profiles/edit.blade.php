                                                            ...
                                                            <div class="row" data-toggle="buttons">
                                                                ...
                                                                <div class="col-6 col-xs-6 left-btn-container">
                                                                    <label class="btn btn-primary @if($user->profile->avatar_status == 1) active @endif btn-block btn-sm" data-toggle="collapse" data-target=".collapseOne.show, .collapseTwo:not(.show)">
                                                                        <input type="radio" name="avatar_status" id="option2" autocomplete="off" value="1" @if($user->profile->avatar_status == 1) checked @endif> Procurar imagem
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="deleteAccount" class="tab-pane fade">
                                                        ...
                                                        <p class="margin-bottom-2 text-center">
                                                            <i class="fa fa-exclamation-triangle fa-fw" aria-hidden="true"></i>
                                                                <strong>Deletar</strong> sua conta é <u><strong>permanente</strong></u> e <u><strong>NÃO</strong></u> pode ser desfeita.
                                                            <i class="fa fa-exclamation-triangle fa-fw" aria-hidden="true"></i>
                                                        </p>
                                                        <hr>
                                                        <div class="row">
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $('#password').password({
            shortPass: 'a senha digitada é muito curta',
            badPass: 'Fraca - Tente combinar letras e numeros',
            goodPass: 'Media - Tente usar caracteres especiais, exemplo !@#$%*()_+ ',
        ...
        function checkPasswordMatch() {
            ...
            if (password != confirmPassword) {
                $("#pw_status").html("As senha não são iguais!");
            }
            else {
                $("#pw_status").html("As senhas são identicas");
            }
        }
