...
use Phalcon\Models\Customer;
use Phalcon\Models\ClientContact;
use Phalcon\Models\PriceType;
use Phalcon\Models\ProjectStatus;
...
class ProjectForm extends Form
{
    ...
    public function initialize($entity = null, $options = [])
    {
        ...
        // Client
        $client = new Select('client_id', Customer::find(), [
            'using'      => ['id', 'name'],
            'useEmpty'   => true,
