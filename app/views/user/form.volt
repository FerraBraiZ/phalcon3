        ...
        <div class="panel-body">
            ...
            <form id="clientefrm" class="form-horizontal" method="post" action="/user/create/">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="input-group input-group-fullwidth">
                            ...
                            <select title="Selecione um g&#234;nero sexual" class="form-control tooltipBubble" name="Sexo"
                                    id="sexo"
                                    maxlength="50">
                        ...
                        <div class="input-group input-group-fullwidth">
                            ...
                            <input title="informe a data de nascimento" type="text" maxlength="10"
                                   class="form-control datepicker tooltipBubble" id="data_aniversario"
                        ...
                        <div class="input-group input-group-fullwidth">
                            <textarea title="Observa&#231;&#245;es diversas ( opcional )" id="observacao"
                                      name="Observa&#231;&#227;o"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-fullwidth text-center">
                            ...
                            <a id="adicionar_telefone" data-fk_id_type="cliente" class="btn btn-success">Adicionar
                                Telefone</a>
                ...
                <div class="input-group input-group-fullwidth">
                    ...
                    <input title="Informe o nome completo da rua, avenida, estrada ( apenas letras )" type="text"
                           maxlength="150"
                ...
                <div class="input-group input-group-fullwidth">
                    ...
                    <input title="Informe, se existir, um complemento, bloco, andar ou ponto de refer&#234;ncia"
                           type="text" maxlength="255" class="form-control tooltipBubble mask_letters_numbers_ws"
                ...
                <div class="input-group input-group-fullwidth">
                    ...
                    <input title="Informe a Cidade" type="text" maxlength="150"
                           class="form-control tooltipBubble mask_letters_numbers_ws"
